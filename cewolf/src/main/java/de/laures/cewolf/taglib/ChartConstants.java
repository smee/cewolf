...
public interface ChartConstants {
	 ...
	 public final static String CHARTTYPE_OVERLAID_XY = "overlaidxy";
	 public final static String CHARTTYPE_OVERLAID_CATEGORY ="overlaidcategory";
	 public final static String CHARTTYPE_COMBINED_XY ="combinedxy";
}
